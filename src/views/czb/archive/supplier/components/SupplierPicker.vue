  ...
  >
    <div>
      <div>
        ...
        <el-input v-model="query.supplierNum" clearable placeholder="供应商编号" style="width: 185px;" class="filter-item" @keyup.enter.native="refresh" />
        <label class="el-form-item-label">供应商名称</label>
        <el-input v-model="query.name" clearable placeholder="供应商名称" style="width: 185px;" class="filter-item" @keyup.enter.native="refresh" />
      ...
      <el-table ref="table" v-loading="loading" :data="tableData" size="small" style="width: 100%;margin:15px 0;" highlight-current-row @current-change="handleCurrentChange">
        ...
        <el-table-column prop="checkOutUnitInfo.name" label="结算单位" show-overflow-tooltip />
...
<script>
import { list } from '@/api/czb/supplier'
